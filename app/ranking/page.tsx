    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">
          Celebrating our most active and positive community members
        </p>
      </div>
      ...
      >
        ...
        <TabsContent value="posts" className="space-y-4">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-muted-foreground">
              Ranked by total number of posts published
            </p>
          </div>
          {getRankingData("posts").map((user) => (
            <Link key={user.id} href={`/ranking/${user.id}`}>
              <Card
                className={`${getRankCardStyle(user.rank)} transition-all hover:shadow-md cursor-pointer`}
              >
        ...
        <TabsContent value="empathy" className="space-y-4">
          <div className="text-center mb-6">
            <h2 className="text-xl font-semibold mb-2">
              Most Appreciated Authors
            </h2>
            <p className="text-sm text-muted-foreground">
              Ranked by total empathy reactions received
            </p>
          </div>
        ...
        <TabsContent value="language" className="space-y-4">
          <div className="text-center mb-6">
            <h2 className="text-xl font-semibold mb-2">
              Positive Communication Champions
            </h2>
            <p className="text-sm text-muted-foreground">
              Ranked by clean language and positive interaction score
            </p>
          </div>
      ...
      <div className="text-center mt-12 p-6 bg-muted/50 rounded-lg">
        ...
        <p className="text-sm text-muted-foreground">
          Rankings are updated daily. Keep contributing positively to climb the
          leaderboard!
        </p>
      </div>
    </div>
