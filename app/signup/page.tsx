        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-11 bg-gray-900 hover:bg-gray-800 text-white border-gray-700"
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-11 bg-yellow-400 hover:bg-yellow-500 text-gray-900 border-yellow-400"
              onClick={() => handleSocialLogin("Kakao")}
            >
              <svg className="mr-2 h-5 w-5" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
                  d="M12 3C7.03 3 3 6.14 3 10.1c0 2.52 1.65 4.74 4.1 6.1l-.95 3.48c-.1.36.26.65.58.45l4.1-2.71c.39.03.78.05 1.17.05 4.97 0 9-3.14 9-7.1S16.97 3 12 3z"
                />
              </svg>
              Continue with Kakao
            </Button>
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-11 bg-green-500 hover:bg-green-600 text-white border-green-500"
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-11 bg-indigo-500 hover:bg-indigo-600 text-white border-indigo-500"
